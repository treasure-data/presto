...
public final class TestIcebergRestCatalogCaseInsensitiveMapping
        extends AbstractTestQueryFramework
{
    ...
    public void setup()
    {
        if (backend.namespaceExists(NAMESPACE)) {
            return;
        }
    ...
    @Test
    public void testCaseInsensitiveMatchingForTable()
    {
    ...
    @Test
    public void testCaseInsensitiveMatchingForView()
    {
        Map<String, String> namespaceMetadata = backend.loadNamespaceMetadata(NAMESPACE);
        String namespaceLocation = namespaceMetadata.get(LOCATION_PROPERTY);
        createDir(namespaceLocation);
