        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        newOptionalBinder(binder, Key.get(boolean.class, ForIcebergSplitManager.class))
        ...
        binder.bind(ConnectorPageSourceProvider.class).annotatedWith(ForClassLoaderSafe.class).to(IcebergPageSourceProviderFactory.class).in(Scopes.SINGLETON);
