...
public class TestS3FileSystemConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(S3FileSystemConfig.class)
                ...
                .setStsEndpoint(null)
                .setStsRegion(null)
                .setStorageClass(S3FileSystemConfig.StorageClassType.STANDARD)
                .setCannedAcl(S3FileSystemConfig.ObjectCannedAcl.NONE)
    ...
    public void testExplicitPropertyMappings()
    {
        ...
        S3FileSystemConfig expected = new S3FileSystemConfig()
                ...
                .setCannedAcl(S3FileSystemConfig.ObjectCannedAcl.BUCKET_OWNER_FULL_CONTROL)
