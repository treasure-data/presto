        ...
        OptionalLong distinctValuesCount)
{
    public ColumnStatistics
    {
        ...
        integerStatistics.ifPresent(ignore -> presentStatistics.add("integerStatistics"));
        doubleStatistics.ifPresent(ignore -> presentStatistics.add("doubleStatistics"));
        decimalStatistics.ifPresent(ignore -> presentStatistics.add("decimalStatistics"));
        dateStatistics.ifPresent(ignore -> presentStatistics.add("dateStatistics"));
        booleanStatistics.ifPresent(ignore -> presentStatistics.add("booleanStatistics"));
