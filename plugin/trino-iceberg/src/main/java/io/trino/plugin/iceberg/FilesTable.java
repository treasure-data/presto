        ...
        implements SystemTable
{
            ...
            implements Iterable<List<Object>>
    {
        ...
        private Block getIntegerBigintSqlMap(Map<Integer, Long> value)
        {
            if (value == null) {
                return null;
            }
        ...
        private Block getIntegerVarcharSqlMap(Map<Integer, ByteBuffer> value)
        {
            if (value == null) {
                return null;
            }
        ...
        private Block toIntegerBigintSqlMap(Map<Integer, Long> values)
        {
        ...
        private Block toIntegerVarcharSqlMap(Map<Integer, String> values)
        {
            return buildMapValue(
