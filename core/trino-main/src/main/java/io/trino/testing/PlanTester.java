        ...
        implements Closeable
{
    ...
    private PlanTester(Session defaultSession, int nodeCountForStats)
    {
        ...
        FunctionManager functionManager = new FunctionManager(createFunctionProvider(catalogManager), globalFunctionCatalog);
        ...
        this.typeAnalyzer = createTestingTypeAnalyzer(plannerContext);
    ...
    {
        return getPlanOptimizersFactory(forceSingleNode).get();
    }
