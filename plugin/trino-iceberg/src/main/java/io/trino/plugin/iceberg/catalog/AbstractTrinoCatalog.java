        ...
        implements TrinoCatalog
{
            ...
            Map<String, Object> materializedViewProperties)
    {
        ...
        Map<String, String> properties = createTableProperties(new ConnectorTableMetadata(storageTableName, columns, materializedViewProperties, Optional.empty()), ignore -> false);
            ...
            Map<String, Object> materializedViewProperties)
    {
        ...
        Transaction transaction = IcebergUtil.newCreateTableTransaction(this, tableMetadata, session, false, tableLocation, ignore -> false);
