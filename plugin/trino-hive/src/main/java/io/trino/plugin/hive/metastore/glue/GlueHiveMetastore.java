        ...
        implements HiveMetastore
{
    ...
    {
        return glueCache.getTables(databaseName, cacheTable -> getTablesInternal(cacheTable, databaseName, ignore -> true));
    }
    ...
    public void replaceTable(String databaseName, String tableName, Table newTable, PrincipalPrivileges principalPrivileges, Map<String, String> environmentContext)
    {
        ...
        updateTable(databaseName, tableName, ignore -> newTable);
    }
    ...
    public static TableInput.Builder asTableInputBuilder(software.amazon.awssdk.services.glue.model.Table table)
    {
        return TableInput.builder()
                ...
                .tableType(GlueConverter.getTableTypeNullable(table))
            ...
            throws EntityNotFoundException
    {
        ...
        Collection<Partition> partitions = batchGetPartition(databaseName, tableName, ImmutableList.copyOf(newStatistics.keySet()), ignore -> {});
    ...
    private static Predicate<software.amazon.awssdk.services.glue.model.Table> createTablePredicate(Set<TableKind> visibleTableKinds)
    {
        ...
        if (visibleTableKinds.contains(TableKind.OTHER)) {
            ...
            Predicate<software.amazon.awssdk.services.glue.model.Table> tableVisibilityFilter = ignore -> true;
        ...
        // inclusion
        Predicate<software.amazon.awssdk.services.glue.model.Table> tableVisibilityFilter = ignore -> false;
