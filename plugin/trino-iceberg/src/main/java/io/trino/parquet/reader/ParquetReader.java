        ...
        implements Closeable
{
            ...
            throws IOException
    {
        ...
        // create a lazy page
        currentPageId++;
        Page page = new ParquetSourcePage(batchSize).getPage();
            ...
            throws IOException
    {
        ...
        if (children.isEmpty()) {
            return new ColumnChunk(createNullBlock(field.getType()), new int[] {}, new int[] {});
        }
            ...
            throws IOException
    {
        ...
        blocks[1] = valueField.isPresent() ? readColumnChunk(valueField.get()).getBlock() : createNullBlock(parameters.get(1));
        ListColumnReader.BlockPositions collectionPositions = calculateCollectionOffsets(field, columnChunk.getDefinitionLevels(), columnChunk.getRepetitionLevels());
            ...
            throws IOException
    {
        ...
        Block rowBlock = fromNotNullSuppressedFieldBlocks(structIsNull.positionsCount(), structIsNull.isNull(), blocks);
    ...
    private void validateWritePageChecksum(Page sourcePage)
    {
        if (writeChecksumBuilder.isPresent()) {
