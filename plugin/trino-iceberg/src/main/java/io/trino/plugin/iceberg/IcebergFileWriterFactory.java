...
public class IcebergFileWriterFactory
{
            ...
            Map<String, String> storageProperties)
    {
        switch (fileFormat) {
            case PARQUET:
                ...
                return createParquetWriter(MetricsConfig.getDefault(), fileSystem, outputPath, icebergSchema, session, storageProperties);
            case ORC:
            ...
            Map<String, String> storageProperties)
    {
        switch (fileFormat) {
            case PARQUET:
                return createParquetWriter(FULL_METRICS_CONFIG, fileSystem, outputPath, POSITION_DELETE_SCHEMA, session, storageProperties);
            case ORC:
